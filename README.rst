...
An experimental native C++17 API is available under ``cpp/``. It does not
embed Python and exposes rosbag reader/writer access for serialized message
bytes plus dynamic typed message objects.
